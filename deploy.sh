...
export DATABASE_URI=mysql+pymysql://root:dB4a15!4@<database_uri>:3306/k8sdb
...
mysql -h terraform-20201120093727436000000002.clh36ghk8zgg.eu-west-1.rds.amazonaws.com -P 3306 -u dbProject -p dB4a15!4 < cne-sfia2-brief/database/Create.sql
